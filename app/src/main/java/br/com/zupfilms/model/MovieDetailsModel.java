...
public class MovieDetailsModel {
    ...
    public MovieDetailsModel(Integer id, String poster_path, String backdrop_path, float vote_average, String title, String release_date, List<GenresResponse> genres, Integer runtime, String overview, List<CountriesResponse> production_countries, String tagline, Integer vote_count, Boolean isFavoriteChecked) {
        this.id = id;
